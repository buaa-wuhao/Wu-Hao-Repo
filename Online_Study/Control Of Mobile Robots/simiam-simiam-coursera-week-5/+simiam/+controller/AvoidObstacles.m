...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
            ...
            %outputs.v = v;
            outputs.w = w;
            % Set Minimum V while satisfying W requirements
            outputs.v = robot.wheel_radius*robot.min_vel-0.5*w*robot.wheel_base_length;
            %outputs.v = 10*(u_x^2+u_y^2)*outputs.v;            
        end
