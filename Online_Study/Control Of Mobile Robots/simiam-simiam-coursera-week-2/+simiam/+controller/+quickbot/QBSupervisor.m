...
%                 fprintf('already in state %s\n', name);
        ...
        %   measured wheel encoder tick counts are stored in prev_ticks.
            ...
            x_dt = m_per_tick*(right_ticks-prev_right_ticks+left_ticks-prev_left_ticks)*cos(theta);
            y_dt = m_per_tick*(right_ticks-prev_right_ticks+left_ticks-prev_left_ticks)*sin(theta);
